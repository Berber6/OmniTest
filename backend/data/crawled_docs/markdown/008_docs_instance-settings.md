# Instance settings | 4ga Boards Docs

Source: https://docs.4gaboards.com/docs/instance-settings
...
![settingsdashboard_en.png](https://docs.4gaboards.com/docs/instance-settings/)
## Users[​](https://docs.4gaboards.com/docs/instance-settings/#users "Direct link to Users")
...
As an administrator, you have control over users information. When you click on the pencil icon, you can access the all of the personal [settings](https://docs.4gaboards.com/docs/settings) of each individual user. You can change them all without knowing their current password. Pretty handy! You can also check account activity — including when the user account was created and when the user’s information was last updated (for example, after a password change). You can also view the user’s activity log, which lists all actions performed across projects and boards.
![instanceusers_en.png](https://docs.4gaboards.com/assets/images/instanceusers_en-f3c4aa19bc6365ba5be908635d247945.png)
...
![instanceusers_en.png](https://docs.4gaboards.com/assets/images/userscolumns_en-d182d0bdd345c3f5e5bf2be50948c8ce.png)
Here is the picture of all columns selected:
![instanceusers_en.png](https://docs.4gaboards.com/assets/images/usersfull_en-42bf351631bc1dffc4929420ec52b41f.png)
## Instance options[​](https://docs.4gaboards.com/docs/instance-settings/#instance-options "Direct link to Instance options")
...
![instance-settings.jpg](https://docs.4gaboards.com/assets/images/instancesettings_en-5e06fc0be3956807f89207ae8447dbd9.png)